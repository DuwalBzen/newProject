...
<head>
  ...
  <title>Bzen - Personal Portfolio </title>
...
<body data-spy="scroll" data-target="#navbarRyan" data-offset="98">
  ...
  <header>
    <nav class="navbar header-nav fixed-top navbar-expand-lg">
      <div class="container">
        <!-- Brand -->
        <a class="navbar-brand" href="#">Bzen Duwal <span class="theme-bg"></span></a>
        <!-- / -->
      ...
      <div class="container">
        <div class="row full-screen align-items-center">
          <div class="col col-md-12 col-lg-8 col-xl-6 p-80px-tb">
            <div class="home-text-center theme-after m-50px-t">
              <h4>Hello, my name is</h4>
              <h5 class="font-alt">Bzen Duwal</h5>
              <p>I'm the programmer,web developer ,traveler.</p>
              <div class="btn-bar">
                <a href="cv_document/bzen_cv_2019.pdf" class="m-btn-link m-btn-link-white theme-after">Download CV</a>
              </div> 
            </div> <!-- home-text-center -->
        ...
        <div class="row align-items-center">
          <div class="col-md-6">
            <div class="about-left">
              <h2>I'm Bzen duwal</h2>
              <h3>I'm a programmer , developer ,pentester from Nepal</h3>
              <p>I do coding, modern websites, web services and online service.</p>
            ...
            <li class="portfolio-item website">
              <div class="portfolio-col portfolio-hover-01">
                <div class="portfolio-img">
                  ...
                  <div class="hover">
                      <div class="action-btn">
                        <a href="https://www.youtube.com/watch?v=Z-Z5WPKLZ4k" class="popup-video theme-color"><i class="fa fa-play"></i></a>
                ...
                <div class="portfolio-info">
                  <h5>Bzen Portpolio </h5>
                  <span>Resent Work Android app</span>
                </div>
              </div> <!-- Portfolio -->
            </li> <!-- col -->
            ...
            <li class="portfolio-item photoshop website">
              <div class="portfolio-col portfolio-hover-01">
                <div class="portfolio-img">
                  ...
                  <div class="hover">
                      <div class="action-btn">
                        <a href="hhttps://www.youtube.com/watch?v=Z-Z5WPKLZ4k" class="popup-video theme-color"><i class="fa fa-play"></i></a>
...
//if "email" variable is filled out, send email
  ...
  //Email information
  $admin_email = "bijen857@gmail.com";
  ...
  <footer class="footer">
      <div class="container">
          <div class="footer-logo">
            <span>Bzen Duwal <span></span></span>
          </div>
          ...
          <p class="copyright">© 2019 Bzen. All Rights Reserved</p>
      </div>
  </footer>
